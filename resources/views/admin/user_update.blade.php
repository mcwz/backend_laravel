        ...
        <div class="col-xs-6">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">@lang('sys.user_update')</h3>
            </div>
            <!-- /.box-header -->
@if (count($errors) > 0)
            ...
            {{ csrf_field() }}
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input readonly="" type="text" name="user_name" class="form-control" id="user_name" placeholder="username" value="{{ $user->name }}" />
                  </div>
                </div>
                <div class="form-group">
                  <label for="user_email" class="col-sm-2 control-label">@lang('sys.user_email')</label>
                  <div class="col-sm-8">
                    <input type="email" name="user_email" class="form-control" id="user_email" placeholder="abc@def.com" value="{{ $user->email }}" />
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="user_description" class="form-control" id="user_description" value="{{ $user->description }}">
                  </div>
                </div>
              ...
              <div class="box-footer">
                <a class="btn btn-default">@lang('sys.cancel')</a>
      ...
      $(function(){
        ...
        $("#avatar").fileinput({
          language:'zh',
              ...
              defaultPreviewContent: '<img src="{{ url('admin/user/showuseravatar/'.$user->id)}}" alt="Your Avatar" style="width:160px">',
